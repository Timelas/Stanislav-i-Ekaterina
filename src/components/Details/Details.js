...
о том, чтобы провести этот вечер без детей.</p>
      ...
      <p className="details__text">Мы всегда рады красивым цветам и букетам, но количество перемещий и длительность праздника могут очень их утомить :)<br />Возможно, вы придумайте оригинальную альтернативу или подарите один букет на несколько семей</p>
    </section>
  );
}
